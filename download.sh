...
if [ $FILE == "pretrained-network" ]; then
    URL=https://www.dropbox.com/scl/fi/akxt03k63b7qb0g5ca69m/010000_nets_ema.ckpt?rlkey=i3pkqmsdsyfimwmnoo82dx7a5&st=o8g2lqgo&dl=0
    ...
    echo "Available arguments are pretrained-network and celeba-hq-dataset."
    exit 1
